...
class WalletScreenView extends StatelessWidget {
            ...
            child: Scaffold(
              ...
              appBar: (controller.profileScreenController.isWalletScreen.value)
                  ? UiInterface().customAppBar(onBackTap: () {
                      controller.profileScreenController.isWalletScreen.value = false;
                      Get.back();
                    }, isBack: true, context, "Wallet Transactions".tr, backgroundColor: AppColors.lightGrey02)
                  : UiInterface().customAppBar(isBack: false, context, "Wallet Transactions".tr, backgroundColor: AppColors.lightGrey02),
                      ...
                      children: [
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  Text(
                                    "Total Amount".tr,
                                    style: const TextStyle(fontSize: 12, color: AppColors.blue03, fontFamily: AppThemData.medium),
                                  ),
                                  const SizedBox(
                                    height: 6,
                                  ),
                                  Text(
                                    Constant.amountShow(amount: controller.customerModel.value.walletAmount.toString()),
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(color: AppColors.darkGrey10, fontWeight: FontWeight.w700, fontSize: 20),
                          ),
                        ),
                        Expanded(
                                              ...
                                              Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: SvgPicture.asset(
                                                    ...
                                                    color: (walletTractionModel.isCredit!) ? AppColors.green04 : AppColors.red04,
                                                  ),
                                                ),
                                              ),
                                              Expanded(
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          Expanded(
                                                            child: Text(
                                                              walletTractionModel.note.toString(),
                                                              style: const TextStyle(
                                                          ...
                                                          Text(
                                                            Constant.amountShow(amount: walletTractionModel.amount.toString()),
                                                            style: const TextStyle(
                                                                color: AppColors.darkGrey07, fontFamily: AppThemData.medium, fontSize: 16),
                                                          )
                                                        ],
                                                      ),
                                                      const SizedBox(
                                                      ...
                                                      Row(
                                                        children: [
                                                          Expanded(
                                                            child: Text(
                                                              Constant.timestampToDate(walletTractionModel.createdDate!),
                                                              style: const TextStyle(
                                                          ...
                                                          Text(
                                                            'Success'.tr,
                                                            style: const TextStyle(
                                                                color: AppColors.green04, fontFamily: AppThemData.medium, fontSize: 12),
                                                          )
                                                        ],
                                                      ),
                                                    ],
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              children: [
                                Visibility(
                                  visible:
                                      controller.paymentModel.value.strip != null && controller.paymentModel.value.strip!.enable == true,
                                  child: cardDecoration(
                                      controller, controller.paymentModel.value.strip!.name.toString(), "assets/images/stripe.png"),
                                ),
                                Visibility(
                                  visible:
                                      controller.paymentModel.value.paypal != null && controller.paymentModel.value.paypal!.enable == true,
                                  child: cardDecoration(
                                      controller, controller.paymentModel.value.paypal!.name.toString(), "assets/images/paypal.png"),
                                ),
                                const SizedBox(
                                  height: 10,
                                ),
                          ...
                          if (controller.amountController.value.text.isNotEmpty) {
                            ...
                            if (double.parse(controller.amountController.value.text) >=
                              ...
                              ShowToastDialog.showToast(
                                  "Please Enter minimum amount of ${Constant.amountShow(amount: Constant.minimumAmountToDeposit)}".tr);
                            }
                          } else {
  ...
  cardDecoration(WalletScreenController controller, String value, String image) {
    return Obx(
      () => Column(
        children: [
          const SizedBox(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      value,
                      style: const TextStyle(fontSize: 16, fontFamily: AppThemData.bold, color: AppColors.grey10),
                    ),
                  ),
                  Radio(
