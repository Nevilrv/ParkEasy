              ...
              appBar: AppBar(
                ...
                title: Padding(
                  ...
                  child: Text(
                    ...
                    style: const TextStyle(color: AppColors.yellow09, fontFamily: AppThemData.medium, fontSize: 14),
                  ),
                ),
                actions: [
                  InkWell(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(left: 16,right: 16.0, top: 10),
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            Text(
                              "Do you need some space for \nparking your vehicle".tr,
                              style: const TextStyle(
                                  color: AppColors.darkGrey10, fontFamily: AppThemData.bold, fontSize: 20),
                            ),
                            const SizedBox(
                              height: 16,
                            ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(color: AppColors.darkGrey10, fontFamily: AppThemData.bold, fontSize: 20),
                    ),
                  ),
                  (controller.isLoading.value)
                      ? (controller.parkingList.isEmpty)
                          ? Expanded(child: Constant.showEmptyView(message: "No Parking Found"))
                          : Expanded(
                                ...
                                return InkWell(
                                  onTap: () {
                                    Get.toNamed(Routes.PARKING_DETAIL_SCREEN,
                                        arguments: {"parkingModel": parkingModel});
                                  },
                                  child: Column(
                                    children: [
                                      Row(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    ...
                                                    maxLines: 1,
                                                    style: const TextStyle(
                                                        color: AppColors.darkGrey07, fontFamily: AppThemData.regular),
                                                  ),
                                                ],
                                              ),
                                            ),
                                          ...
                                          parkingModel.likedUser!.contains(FireStoreUtils.getCurrentUid())
                                              ? AnimatedSwitcher(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    key: ValueKey(parkingModel.likedUser!
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: const TextStyle(
                                                color: AppColors.darkGrey06, fontFamily: AppThemData.bold),
                                          ),
                                          const SizedBox(
                                            width: 11,
                                          ),
                      ...
                      : Constant.loader(),const SizedBox(height: 12,)
                ],
              ));
        });
  }
