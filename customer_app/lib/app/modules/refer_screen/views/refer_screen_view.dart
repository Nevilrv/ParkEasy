...
Future<void> share(ReferScreenController controller) async {
  await FlutterShare.share(
    title: 'ParkEasy'.tr,
    text:
        'Hey there, thanks for choosing ParkEasy. Hope you love our product. If you do, share it with your friends using code ${controller.referralModel.value.referralCode.toString()} and get ${Constant.amountShow(amount: Constant.referralAmount)}.'
            .tr,
  );
}
